...
public class Clasroom {
	...
	public String toString() {
		return "Clasroom [nombre=" + nombre + ", proyector=" + proyector + ", pizarra=" + pizarra
				+ ", puestoDeProfesor=" + puestoDeProfesor + ", puestosDeAlumnos=" + puestosDeAlumnos.size() + "]";
	}
